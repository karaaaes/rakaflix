            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{ route('member.register.store') }}" method="POST" enctype="multipart/form-data" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('name') }}"/>
                                @error('name')
                                <div class="text-red-700 px-2 rounded relative text-sm" role="alert">
